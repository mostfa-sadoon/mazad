<?php
$active_links = ['recognitions' , 'showrecognitions'];
?>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        ...
                                        <form action="{{ route('admin.recognitions') }}" method="get">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-3" style="padding-right: 0px !important;">
                                                    ...
                                                    <a class="btn btn-outline-primary  btn-min-width box-shadow-3"
                                                        href="{{ route('admin.recognitions.create') }}">
                                                        {{__('admin/forms.add')}}
                                                    </a>
                                                </div>
                                        ...
                                        <table
                                            ...
                                            <tbody>
                                                ...
                                                @foreach($recognitions as $recog)
                                                    <tr>
                                                        <td >{{$recog->name}}</td>
                                                        <td><span class="badge badge-info">{{$recog->days}}</span></td>
                                                        <td class="text-success">{{$recog->price}}</td>
                                                        <td>
                                                            <div class="btn-group" role="group" aria-label="Basic example">
    
                                                                <a href="{{route('admin.recognitions.edit', ['id'=> $recog -> id])}}"
                                                                   class="btn btn-info box-shadow-3 mr-1 "><i class="ft-edit"></i></a>
    
                                                                <a href="{{route('admin.recognitions.delete', ['id'=> $recog -> id])}}"
                                        ...
                                        <div class="justify-content-center d-flex">
                                            {!! $recognitions->appends(Request::except('page'))->render() !!}
                                        </div>
                                    </div>
                                </div>
                            </div>
