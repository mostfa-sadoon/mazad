                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.attributes', ['category_id'=> $category->id]) }}">{{__('admin/forms.attributes')}}</a>
                            </li>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" action="{{route('admin.attributes.store' , ['category_id'=> $category->id])}}" method="post"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="type" class="select2 form-control">
                                                        <option disabled selected >من فضلك أختر قيمه</option>
                                                            ...
                                                            <option value="1">قيمه رقميه</option>
                                                            <option value="2">قيمه نصيه</option>
                                                        </optgroup>
                                                    </select>
                                                    @error('type')
                                                    <span class="text-danger"> {{$message}}</span>
