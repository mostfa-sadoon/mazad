<?php
$active_links = ['countries' , 'addcountries'];
?>
                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"> {{__('admin/sidebar.add_country')}}
                            </li>
                        </ol>
                    </div>
                </div>
                                ...
                                <div class="card-body">
                                    <form class="form" action="{{route('admin.countries.store')}}" method="post"
                                        ...
                                        <div class="form-body">
                                            ...
                                            <h4 class="form-section"><i class="ft-home"></i> بيانات الدوله </h4>
