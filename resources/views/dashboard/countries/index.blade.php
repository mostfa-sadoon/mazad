<?php
$active_links = ['countries' , 'showcountries'];
?>
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> {{__('admin/sidebar.countries')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <h3 class="card-title">{{__('admin/sidebar.countries')}}</h3>
                                        ...
                                        <table
                                            ...
                                            <tbody>
                                                ...
                                                @foreach($countries as $city)
                                                    <tr>
                                                        <td >{{$city->name}}</td>
                                                        <td class="text-info">{{$city->currency}}</td>
                                                        <td><img src="{{$city->image}}" class="img-thumbnail" style="width: 50px;"></td>
                                                        <td>
                                                            <div class="btn-group" role="group" aria-label="Basic example">
    
                                                                <a href="{{route('admin.countries.edit', ['id'=> $city -> id])}}"
                                                                   class="btn btn-info box-shadow-3 mr-1 "><i class="ft-edit"></i></a>
    
                                                                <a href="{{route('admin.countries.delete', ['id'=> $city -> id])}}"
