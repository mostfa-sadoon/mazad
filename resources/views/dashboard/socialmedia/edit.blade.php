<?php
$active_links = ['socialmedia' , 'editsocialmedia'];
?>
                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"> {{$Socialmedia->Socialmedia}}
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" action="{{route('admin.socialmedia.update')}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <input name="id" value="{{$Socialmedia->id}}" type="hidden">
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                 <div class="gorm-group col-6">
                                                    <label>{{__('admin/forms.'.Config::get('app.locale').'.url')}}</label>
                                                     <input class="form-control" type="text" name="url" value="{{$Socialmedia->url}}">
                                                 </div>
                                                 <div class="gorm-group col-6">
                                                    <label>{{__('admin/forms.'.Config::get('app.locale').'.icon')}}</label>
                                                    <input class="form-control" type="text" name="icon" value="{{$Socialmedia->icon}}">
                                                </div>
                                            </div>
                                        </div>
