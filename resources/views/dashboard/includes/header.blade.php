                ...
                <ul class="nav navbar-nav float-right">
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <span>{{__('admin/sidebar.hi')}}
                                <span  style="padding-top: 8px;" class="user-name text-bold-700"> {{auth('admin')->user()->name}}</span>
                            </span>
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        <a class="nav-link " href="#" ><i class="ficon ft-bell"></i>
                            <span
                                class="badge badge-pill badge-default badge-danger badge-default badge-up badge-glow">{{ App\Models\Auction::count() }}</span>
                        </a>
