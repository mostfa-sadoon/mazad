                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"> {{__('admin/sidebar.logo')}}
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" action="{{route('admin.Logo.update')}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <input name="id" value="{{$logo->id}}" type="hidden">
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-2">
                                                            <img src="{{$logo->logo}}" class="img-thumbnail" style="margin-top: 2.3rem !important;width: 50px;">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
